                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                          ...
                          <ul class="sub">
                            ...
                            <li><a class="active" href="rekamankajian.php">Kelola Rekaman</a></li>
                          </ul>
                        </li>
                        <li class="sub-menu">
                          <a href="javascript:;">
           ...
           <div class="panel panel-default">
              ...
              <div class="row w3-res-tb">
                <div class="col-sm-2 m-b-xs">
                  <select id="indeks" onchange="FunctionOnChange()" class="input-sm form-control w-sm inline v-middle">
                    ...
                    <option value="1">Judul Kajian</option>
                  </select>                
                </div>
                <div class="col-sm-3">
              ...
              <div>
                <table id="myTable" class="table" ui-jq="footable" ui-options='{
                  ...
                  <tbody>
                    <?php 
                      $query = "SELECT * FROM rekaman_kajian";
                    ...
                    <tr>
                      ...
                      <td>
                        <?php 
                          if (file_exists("file/".$row['rekaman'])==1) {
                            ?>
                            <audio controls>
                              <source src="file/<?php echo $row['rekaman']; ?>" />
                            </audio>
                            <?php
                          } else{
                      ...
                      <td>
                        ...
                        <div id="myModal<?php echo $row['id']; ?>" class="modal fade" role="dialog">
                                <?php include "pages/modal-rekaman.php"; ?>
                        </div>
                         <!-- Modal End -->
                      </td>
                    </tr>
